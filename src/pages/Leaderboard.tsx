...
const Leaderboard: FC<LeaderboardProps> = () => {
  ...
  return (
    <>
      ...
      >
        <p className="text-[33px] leading-[31px] font-[700] text-[#F7FF98]">
          {getUserRank()}
        </p>
      ...
      >
        <thead className="bg-[#2B2D2C] border-b-[0.5px] border-b-[#D9D9D9] text-[8px] font-[700] text-[#F7FF98] w-full h-[25px] rounded-t-[8px]">
          <tr>
            <th>#</th>
            <th>User</th>
            <th>Points</th>
